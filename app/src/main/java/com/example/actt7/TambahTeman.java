...
public class TambahTeman extends AppCompatActivity {
    ...
    private static final String TAG = com.example.actt7.TambahTeman.class.getSimpleName();
    ...
    public void SimpanData()
    {
        if (editNama.getText().toString().equals("")||editTelpon.getText().toString().equals("")){
            Toast.makeText(com.example.actt7.TambahTeman.this, "Semua harus diisi data",Toast.LENGTH_SHORT).show();
        }
        else {
            ...
            StringRequest strReq = new StringRequest(Request.Method.POST, url_insert, new Response.Listener<String>(){
                ...
                public void onResponse(String response){
                    ...
                    try {
                        ...
                        if (success == 1){
                            Toast.makeText(com.example.actt7.TambahTeman.this, "Sukses simpan data", Toast.LENGTH_SHORT).show();
                        }else{
                            Toast.makeText(com.example.actt7.TambahTeman.this,"gagal",Toast.LENGTH_SHORT).show();
                        }
                ...
                public void onErrorResponse(VolleyError error){
                    ...
                    Toast.makeText(com.example.actt7.TambahTeman.this,"Gagal simpan data",Toast.LENGTH_SHORT).show();
                }
            }){
                @Override
